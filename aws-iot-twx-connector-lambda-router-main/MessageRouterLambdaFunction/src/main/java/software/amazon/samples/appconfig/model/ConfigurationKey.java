package software.amazon.samples.appconfig.model;

import java.util.Objects;

/**
 * Model to access AppConfig
 *
...
public class ConfigurationKey {
     ...
     *
     * @param application   Name or Id of the Application that the configuration belongs to.
     *                      Corresponds to the 'application' field on
     *               {@link software.amazon.awssdk.services.appconfig.model.GetConfigurationRequest}
     * @param environment   Name or Id of the Environment that the configuration belongs to.
     *                      Corresponds to the 'environment' field on
     *               {@link software.amazon.awssdk.services.appconfig.model.GetConfigurationRequest}
     * @param configuration Name or Id of the ConfigurationProfile that the configuration is
     *                      associated with. Corresponds to the 'configuration'
     *                      field on
     *               {@link software.amazon.awssdk.services.appconfig.model.GetConfigurationRequest}
     */
